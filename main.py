...
def parse_task(task: str):
    ...
    to_execute = str(response_data['choices'][0]['message']['content'])
    # convert to string
    ...
    elif to_execute == 'count_weekday':
        return handle_task_A3()
    elif to_execute == 'sort_contacts':
        return handle_task_A4()
    elif to_execute == 'recent_logs':
        return handle_task_A5()
    elif to_execute == 'markdown_index':
        return handle_task_A6()
    elif to_execute == 'extract_email':
        return handle_task_A7()
    elif to_execute == 'extract_card':
        return handle_task_A8()
    elif to_execute == 'similar_comments':
        return handle_task_A9()
    elif to_execute == 'ticket_sales':
